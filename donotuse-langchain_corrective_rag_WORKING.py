...
With OpenAI GPT and Streamlit Frontend
UPDATED VERSION - Compatible with latest LangChain
"""
...
Answer:"""
    ...
    def query(self, question):
        ...
        # Create prompt
        prompt = self.create_corrective_prompt()
...
def main():
    ...
    with tab3:
        ...
        **User asks:** *"Is there a 90-day waiting period?"*
        
        **System retrieves:** 
        - Employee Handbook 2024 (Day 1 coverage)
        - HR Memo (90-day period eliminated Jan 2024)
        
        **GPT detects:** Outdated assumption
        
        **Response:** "No! The 90-day waiting period was ELIMINATED..."
        
        This is **Corrective RAG** in action! ✨
        """)
